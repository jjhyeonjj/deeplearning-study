...
'''
    tr.Compose() : 여러개의 이미지 전처리 기능을 연결해서 사용할 수 있게 해주는 함수임
...
# batch_size는 각각의 샘플 갯수, shuffle은 샘플을 섞어서 읽어옴
