'''
    ...
    2. Artificial Intelligence(인공 지능)
        1) 인간의 학습 능력과 추론, 지각 능력을 인공적으로 구현한 것
            - 인간처럼 사고하기, 인간처럼 행동하기, 합리적으로 사고하기
        2) 머신 러닝(Machine learning)은 매우 구체적이고 엄밀한 정의를 가지고 있다
            - 반복적인 학습을 통해 분류 성능을 점점 향상시킬 수 있는 효율적인 알고리즘이 기계학습을 수행
        3) 요약
            - 학습(learning)
            - 빅데이터(Big Data)
            - 추론(Reasoning)
